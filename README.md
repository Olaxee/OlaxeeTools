...
- Detects your **local IPv4** and **IPv6** addresses.
...
|-----------|----------|-------|--------|------|
| 🪟 **Windows / macOS / Linux** | 2.0.80 | `iP_OlaxeeTools.exe` | `0db949fb0fccfa38b0a161c69419c0a6993b5adaf9b7e8afc6815736ce5619b5` | 12.4 MB |
...
3. Open the app — your local IPv4 and IPv6 will appear.
